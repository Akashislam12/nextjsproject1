    ...
    <div>
        <div className='flex m-40'>
          ...
          <div>
            ...
            <ul className='ml-3'>
              <li>1.Html,Css</li>
              <li>2.Programing Language(JavaScript)</li>
              <li>3.ReactJs</li>
              <li>4.NextJs</li>
              <li>5.NodeJs</li>
              <li>6.Expressjs</li>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/3">
        <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Programing</h2>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">Love the Programing and like this</h1>
          <p class="leading-relaxed mb-3">I am a new learner.I just learn new technology. and i love leran new technology. </p>
          <a href='./blog' class="text-indigo-500 inline-flex items-center">Learn More
      ...
      <div class="p-4 lg:w-1/3">
        <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Language Of Technology</h2>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">Programing Language </h1>
          <h2 class="leading-relaxed mb-3">JavaScript</h2>
          <p>Other Technologay related JavaScript</p>
      ...
      <div class="p-4 lg:w-1/3">
        <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Career</h2>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">I have a big <span className='text-5xl'>Dream</span></h1>
          <p class="leading-relaxed mb-3">I want to be a good progamre. For that i have to Hardwrok. and i wil/ day by day i improve my skill and with that i also improve myself </p>
          <a class="text-indigo-500 inline-flex items-center">Learn More
            <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path d="M5 12h14"></path>
              <path d="M12 5l7 7-7 7"></path>
